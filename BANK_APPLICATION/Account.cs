...
//                    if (account.accountType == accountType && account.email == email) // Fixed: Added condition check
//                    {
//                        Console.WriteLine($" Account Type: {account.accountType} and email {account.email}, already exist");
//                        exit2 = true;
//                    }
...
//                // Fixed: Return null if account already exists
//                if (exit1 || exit2)
//                {
//                    Console.WriteLine("Account creation failed due to duplicate account.");
//                    return null;
...
//            {
//                Console.WriteLine(ex.Message);
//                return null; // Fixed: Return null when exception occurs
//            }
//        }
